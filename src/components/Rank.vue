<template>
  <section>
    <div class="rank_wrap solo">
      ...
      <p class="gameCount"><strong class="position">{{ $store.getters.getMatchList.positions[0].position }} </strong>(총 {{ _soloRank.wins + _soloRank.losses }}게임)</p>
    ...
    <div class="rank_wrap team">
      ...
      <p class="gameCount"><strong class="position">{{ $store.getters.getMatchList.positions[0].position }} </strong>(총 {{ _teamRank.wins + _teamRank.losses }}게임)</p>
